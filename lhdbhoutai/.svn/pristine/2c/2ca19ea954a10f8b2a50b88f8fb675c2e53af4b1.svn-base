						...
						<div class="booking-search">
							<form action="#" class="form-horizontal showallform">
								...
								<div id="btns" class="pull-left">
									...
									<input type="button" class="btn userinputbtn" name="btn" id="blackbtn" disabled="disabled" onclick="sendFeng()" value="黑名单/解开" />
									<input type="button" class="btn userinputbtn" name="btn" id="setpwd" disabled="disabled" data-toggle='modal' data-target='#updatePwd' value="设置密码" />
								</div>
							</form>
						</div>
						<!--进行帅选信息的条件  end-->
...
<!-- 模态框（Modal） -->
<div style="width:330px;display:none" class="modal fade" id="updatePwd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
   			<div class="modal-header">
      		<button type="button" class="close"	data-dismiss="modal" aria-hidden="true"></button>
      		...
      		<div class="modal-body">
      			<form action="">
      				<table>
      					<tr>
      						<td>设置密码:</td>
      						<td><input id="userpwd" name="userpwd" type="text" /></td>
      					</tr>
      					<tr>
      				</table>
      			</form>
    		...
    		<div class="modal-footer">
				<button type="button" onclick="setpwd();" id="btn_xydjy" class="btn btn-primary">确定</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
		</div><!-- /.modal-content -->
	</div>
